...
You first need to make sure you have `PurrNet v1.14.0` or higher [installed ](https://purrnet.gitbook.io/docs/getting-started/installation-setup)as PurrDiction uses PurrNet to function.
...
<https://assetstore.unity.com/packages/slug/329734>
